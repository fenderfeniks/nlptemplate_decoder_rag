        ...
        for mod_key, mod_cfg in builder_cfg.modifiers.items():
            ...
            if "PEFTModifier" in target:
                if lora_path is None:
                    ...
                    OmegaConf.update(builder_cfg.modifiers[mod_key], "is_trainable", False, force_add=True)
                    OmegaConf.update(builder_cfg.modifiers[mod_key], "gradient_checkpointing", False, force_add=True)
