...
class TestResponseCleaner:
    def test_empty_string(self):
        """Проверка безопасной работы с пустой строкой[cite: 34]."""
        cleaner = ResponseCleaner()
        assert cleaner.clean("") == ""
        assert cleaner.clean(None) == ""

    def test_strip_prompt(self):
        """Проверка удаления эхо-промпта из начала ответа[cite: 34]."""
    ...
    def test_trim_incomplete_sentence(self):
        """Проверка отсечения незавершенных предложений[cite: 34]."""
